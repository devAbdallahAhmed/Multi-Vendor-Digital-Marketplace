...
<div class="container-xl py-4">
    ...
    @if(auth()->user()->latestKyc?->status === 'pending')
        <div class="alert alert-warning border-0 shadow-sm rounded-4 d-flex align-items-center gap-3 p-4 mb-4">

            <div class="bg-warning-subtle text-warning rounded-4 d-flex align-items-center justify-content-center"
