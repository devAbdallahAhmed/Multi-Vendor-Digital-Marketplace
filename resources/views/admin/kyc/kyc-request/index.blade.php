                                    ...
                                    <tr class="table-row">
                                        ...
                                        <td class="py-3">
                                            ...
                                            @elseif($kyc->status === 'pending')
                                                <span
                                                    class="badge bg-warning-subtle text-warning border border-warning-subtle px-3 py-2 rounded-pill fw-semibold">
                                            ...
                                            @else
                                                <span
                                                    class="badge bg-danger-subtle text-danger border border-danger-subtle px-3 py-2 rounded-pill fw-semibold">
                                        ...
                                        <td class="py-3 text-center">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center gap-2">
                                                ...
                                                <form action="{{ route('admin.kyc-request.destroy', $kyc->id) }}"
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-icon btn-sm btn-light border rounded-3 action-btn"
                                                        data-bs-toggle="tooltip" title="{{ __('Delete Request') }}">
