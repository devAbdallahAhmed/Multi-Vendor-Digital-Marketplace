    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <x-admin.input-text name="name" label="{{ __('Name') }}" placeholder="Enter Full Name"  />
            </div>

            <div class="col-md-6 mb-3">
                <x-admin.input-text name="email" type="email" label="{{ __('Email Address') }}" placeholder="admin@example.com"  />
            </div>
        ...
        @endforeach
            ...
            <div class="card-footer text-end">
                <button type="submit" class="btn btn-primary px-4">
                    <i class="ti ti-plus me-1"></i> {{ __('Create & Assign') }}
                </button>
            </div>
                </form>
                            </div>
